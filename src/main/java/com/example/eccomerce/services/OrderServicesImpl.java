...
public class OrderServicesImpl implements IOrderServices {
    ...
    public BaseResponse create(CreateOrderRequest request) {
        ...
        String message = simulateTransaction(order) ? "The order was created"
    ...
    public BaseResponse list() {
        ...
        return BaseResponse.builder().data(responses).message("find all orders").success(true)
    ...
    public BaseResponse get(Long id) {
        ...
        return BaseResponse.builder().data(from(order)).message("order for: " + id).success(true)
                .httpStatus(HttpStatus.FOUND).build();
    }
    ...
    public BaseResponse getByType(String paymentMethod) {
        PaymentType type = converter.convertToEntityAttribute(paymentMethod);
    ...
    private void addProducts(CreateOrderRequest request, Order order) {
        ...
        for (ProductCantRequest productCantRequest : list) {
            ...
            costTotal += (productServices.findById(productCantRequest.getId()).getPrice())
                    * productCantRequest.getCant();
        }
